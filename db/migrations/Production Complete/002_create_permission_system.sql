-- Migration: Create dynamic role and permission management system
-- Date: 2025-10-22
...
CREATE TABLE IF NOT EXISTS permissions (
    ...
    permission_key VARCHAR(100) UNIQUE NOT NULL,  -- e.g., 'manage_users', 'view_analytics'
    permission_name VARCHAR(100) NOT NULL,         -- Display name: 'Manage Users'
    description TEXT,                              -- What this permission allows
    category VARCHAR(50),                          -- Group permissions: 'users', 'tournaments', 'courses'
...
CREATE TABLE IF NOT EXISTS roles (
    id SERIAL PRIMARY KEY,
    role_name VARCHAR(50) UNIQUE NOT NULL,        -- e.g., 'Admin', 'Club Pro'
    role_key VARCHAR(50) UNIQUE NOT NULL,         -- Slug: 'admin', 'club_pro'
    description TEXT,
...
-- We'll keep the old 'role' column for backward compatibility during migration
